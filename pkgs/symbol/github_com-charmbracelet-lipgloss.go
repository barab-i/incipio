...
func init() {
	Symbols["github.com/charmbracelet/lipgloss/lipgloss"] = map[string]reflect.Value{
		...
		"ASCIIBorder":              reflect.ValueOf(lipgloss.ASCIIBorder),
		...
		"MarkdownBorder":           reflect.ValueOf(lipgloss.MarkdownBorder),
		"NewRange":                 reflect.ValueOf(lipgloss.NewRange),
		...
		"StyleRanges":              reflect.ValueOf(lipgloss.StyleRanges),
		...
		"Range":                 reflect.ValueOf((*lipgloss.Range)(nil)),
